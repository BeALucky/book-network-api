...
import com.projects.book.history.BookTransactionHistoryRepo;
...
public class BookService {
	...
	private final BookTransactionHistoryRepo transactionHistoryRepository;
	...
	public PageResponse<BookResponse> findAllBoooks(int page, int size, Authentication connectedUser){
		...
		return new PageResponse<>(
				bookResponse, books.getNumber(),
				books.getSize(), books.getTotalElements(), books.getTotalPages()
...
User user = ((User) connectedUser.getPrincipal());
  ...
  return new PageResponse<>(
	 ...
	 public Integer borrowBook(Integer bookId, Authentication connectedUser) {
		 ...
		 final boolean isAlreadyBorrowed = transactionHistoryRepository.isAlreadyBorrowedByUser(bookId, bookId);
